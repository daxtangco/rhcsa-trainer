  ...
  return (
    <div className="mx-auto max-w-3xl p-8 text-zinc-200">
      ...
      <p className="mt-2 text-xs text-zinc-500">
        Starting reverts the lab VM to the clean snapshot and runs the task's setup. It takes about
        fifteen seconds and discards anything left over from a previous attempt.
      </p>
    </div>
  )
}
